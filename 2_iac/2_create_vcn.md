...
- VCNを作成するためのリソース情報を記載：  [main.tf](./vcn/main.tf)
- `terraform apply`実行後の出力結果で表示する項目を記載：  [outputs.tf](./vcn/outputs.tf)
- OCIへアクセスするためのプロバイダー情報を記載：  [provider.tf](./vcn/provider.tf)
- 変数として使用する情報を記載：  [variables.tf](./vcn/variables.tf)
...
- Using previously-installed oracle/oci v5.25.0
...
Terraform will perform the following actions:
  ...
  # oci_core_default_security_list.default_security_list will be created
...
### (実行例)terraform apply
```console
[opc@test-vm1 vcn]$terraform apply -auto-approve
data.oci_core_services.all_oci_services: Reading...
data.oci_core_services.all_oci_services: Read complete after 0s [id=CoreServicesDataSource-0]
...
oci_core_vcn.generated_oci_core_vcn: Creation complete after 1s [id=ocid1.vcn.oc1.ap-tokyo-1.aaaaaaaaxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx]
oci_core_nat_gateway.nat_gateway: Creating...
oci_core_default_security_list.default_security_list: Creating...
...
oci_core_security_list.private_security_list: Creation complete after 0s [id=ocid1.securitylist.oc1.ap-tokyo-1.aaaaaaaaxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx]
oci_core_default_security_list.default_security_list: Creation complete after 0s [id=ocid1.securitylist.oc1.ap-tokyo-1.aaaaaaaaxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx]
oci_core_internet_gateway.internet_gateway: Creation complete after 0s [id=ocid1.internetgateway.oc1.ap-tokyo-1.aaaaaaaaxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx]
...
oci_core_route_table.route_table_public: Creation complete after 1s [id=ocid1.routetable.oc1.ap-tokyo-1.aaaaaaaaxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx]
oci_core_subnet.public_subnet: Creating...
oci_core_nat_gateway.nat_gateway: Creation complete after 1s [id=ocid1.natgateway.oc1.ap-tokyo-1.aaaaaaaaxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx]
oci_core_default_route_table.default_route_table: Creating...
oci_core_default_route_table.default_route_table: Creation complete after 1s [id=ocid1.routetable.oc1.ap-tokyo-1.aaaaaaaaxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx]
...
oci_core_subnet.private_subnet: Creation complete after 2s [id=ocid1.subnet.oc1.ap-tokyo-1.aaaaaaaaxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx]
...
```console
[opc@test-vm1 vcn]$terraform destroy -auto-approve
data.oci_core_services.all_oci_services: Reading...
...
oci_core_default_security_list.default_security_list: Refreshing state... [id=ocid1.securitylist.oc1.ap-tokyo-1.aaaaaaaaxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx]
...
oci_core_default_route_table.default_route_table: Refreshing state... [id=ocid1.routetable.oc1.ap-tokyo-1.aaaaaaaaxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx]
...
Terraform will perform the following actions:
  ...
  # oci_core_default_route_table.default_route_table will be destroyed
  - resource "oci_core_default_route_table" "default_route_table" {
      - compartment_id             = "ocid1.compartment.oc1..aaaaaaaaxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx" -> null
      - defined_tags               = {
          - "Oracle-Tags.CreatedBy" = "oracleidentitycloudservice/test@test.com"
          - "Oracle-Tags.CreatedOn" = "2024-01-25T10:36:08.523Z"
        } -> null
      ...
      - time_created               = "2024-01-25 10:36:08.588 +0000 UTC" -> null
  ...
  # oci_core_default_security_list.default_security_list will be destroyed
  - resource "oci_core_default_security_list" "default_security_list" {
      - compartment_id             = "ocid1.compartment.oc1..aaaaaaaaxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx" -> null
      - defined_tags               = {
          - "Oracle-Tags.CreatedBy" = "oracleidentitycloudservice/test@test.com"
      ...
      - display_name               = "default_security_list" -> null
      - freeform_tags              = {} -> null
  ...
  - resource "oci_core_internet_gateway" "internet_gateway" {
      ...
      - defined_tags   = {
          - "Oracle-Tags.CreatedBy" = "oracleidentitycloudservice/test@test.com"
          - "Oracle-Tags.CreatedOn" = "2024-01-25T10:36:09.029Z"
        } -> null
      ...
      - state          = "AVAILABLE" -> null
      - time_created   = "2024-01-25 10:36:09.064 +0000 UTC" -> null
  ...
  - resource "oci_core_nat_gateway" "nat_gateway" {
      ...
      - defined_tags   = {
          - "Oracle-Tags.CreatedBy" = "oracleidentitycloudservice/test@test.com"
          - "Oracle-Tags.CreatedOn" = "2024-01-25T10:36:09.061Z"
        } -> null
  ...
  - resource "oci_core_route_table" "route_table_public" {
      ...
      - defined_tags   = {
          - "Oracle-Tags.CreatedBy" = "oracleidentitycloudservice/test@test.com"
          - "Oracle-Tags.CreatedOn" = "2024-01-25T10:36:09.503Z"
        } -> null
      - display_name   = "route_table_public" -> null
      - freeform_tags  = {} -> null
      - id             = "ocid1.routetable.oc1.ap-tokyo-1.aaaaaaaaxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx" -> null
      - state          = "AVAILABLE" -> null
      - time_created   = "2024-01-25 10:36:09.525 +0000 UTC" -> null
      - vcn_id         = "ocid1.vcn.oc1.ap-tokyo-1.aaaaaaaaxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx" -> null
  ...
  - resource "oci_core_security_list" "private_security_list" {
      ...
      - defined_tags   = {
          - "Oracle-Tags.CreatedBy" = "oracleidentitycloudservice/test@test.com"
          - "Oracle-Tags.CreatedOn" = "2024-01-25T10:36:09.039Z"
        } -> null
      - display_name   = "private_security_list" -> null
      - freeform_tags  = {} -> null
      - id             = "ocid1.securitylist.oc1.ap-tokyo-1.aaaaaaaaxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx" -> null
      - state          = "AVAILABLE" -> null
      - time_created   = "2024-01-25 10:36:09.065 +0000 UTC" -> null
      - vcn_id         = "ocid1.vcn.oc1.ap-tokyo-1.aaaaaaaaxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx" -> null
  ...
  - resource "oci_core_service_gateway" "service_gateway" {
      ...
      - defined_tags   = {
          - "Oracle-Tags.CreatedBy" = "oracleidentitycloudservice/test@test.com"
          - "Oracle-Tags.CreatedOn" = "2024-01-25T10:36:09.006Z"
        } -> null
      ...
      - state          = "AVAILABLE" -> null
      - time_created   = "2024-01-25 10:36:09.355 +0000 UTC" -> null
      - vcn_id         = "ocid1.vcn.oc1.ap-tokyo-1.aaaaaaaaxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx" -> null
  ...
  - resource "oci_core_subnet" "private_subnet" {
      ...
      - defined_tags               = {
          - "Oracle-Tags.CreatedBy" = "oracleidentitycloudservice/test@test.com"
          - "Oracle-Tags.CreatedOn" = "2024-01-25T10:36:10.880Z"
        } -> null
      ...
      - time_created               = "2024-01-25 10:36:10.919 +0000 UTC" -> null
      - vcn_id                     = "ocid1.vcn.oc1.ap-tokyo-1.aaaaaaaaxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx" -> null
      - virtual_router_ip          = "10.0.1.1" -> null
      - virtual_router_mac         = "00:00:17:19:DB:34" -> null
    }
  ...
  - resource "oci_core_subnet" "public_subnet" {
      ...
      - defined_tags               = {
          - "Oracle-Tags.CreatedBy" = "oracleidentitycloudservice/test@test.com"
          - "Oracle-Tags.CreatedOn" = "2024-01-25T10:36:09.866Z"
        } -> null
      - dhcp_options_id            = "ocid1.dhcpoptions.oc1.ap-tokyo-1.aaaaaaaaxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx" -> null
      ...
      - time_created               = "2024-01-25 10:36:09.914 +0000 UTC" -> null
      - vcn_id                     = "ocid1.vcn.oc1.ap-tokyo-1.aaaaaaaaxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx" -> null
...
oci_core_default_security_list.default_security_list: Destroying... [id=ocid1.securitylist.oc1.ap-tokyo-1.aaaaaaaaxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx]
...
oci_core_default_route_table.default_route_table: Destroying... [id=ocid1.routetable.oc1.ap-tokyo-1.aaaaaaaaxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx]
...
oci_core_default_route_table.default_route_table: Destruction complete after 0s
...
oci_core_route_table.route_table_public: Destruction complete after 0s
...
oci_core_internet_gateway.internet_gateway: Destruction complete after 1s
oci_core_nat_gateway.nat_gateway: Destruction complete after 1s
oci_core_service_gateway.service_gateway: Destruction complete after 4s
