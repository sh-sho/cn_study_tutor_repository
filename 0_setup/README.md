...
- git commit
```
[opc@cn cn-study_public]$ git commit -m "Add test.txt"
[season2 a9f66c7] Add test.txt
 Committer: Oracle Public Cloud User <opc@cn.sub10241225480.vcn.oraclevcn.com>
...
[opc@cn cn-study_public]$ git config --global user.name "E.NAKAGAWA"
[opc@cn cn-study_public]$ git config --global user.email sonick2010@gmail.com
[opc@cn cn-study_public]$
[opc@cn cn-study_public]$ git config --global user.name
E.NAKAGAWA
[opc@cn cn-study_public]$ git config --global user.email
sonick2010@gmail.com
[opc@cn cn-study_public]$
```
- git push
```
[opc@cn cn-study_public]$ git branch
  main
* season2
[opc@cn cn-study_public]$ git push
...
remote: To https://github.com/hatoreka/cn-study_public.git
   a27100a..a9f66c7  season2 -> season2
```  

- git switch
 ```[opc@cn-ol9 cn-study_public]$ git branch -r
  origin/#5_IaC
  origin/HEAD -> origin/main
  origin/main
  origin/season2
[opc@cn-ol9 cn-study_public]$ git switch origin season2
fatal: only one reference expected
[opc@cn-ol9 cn-study_public]$ git switch season2
branch 'season2' set up to track 'origin/season2'.
Switched to a new branch 'season2'
